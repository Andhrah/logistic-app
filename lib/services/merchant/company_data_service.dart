...
class AddCompanyDataService {
  Future<dynamic> addCompanyData(String token, String name, String email, String phoneNumber, String rcNumber, String cacDocument) async {
    var body = {
      "data": {
        "name": name,
        "email": email,
