class TimeAgo {
  ...
  static String getTimeAgo(int timeStamp,
      {Language? language, bool isShort = false, int? now}) {
  ...
  static String getTimeWithSuffix(
      {Language? language,
      bool isShort = false,
    ...
    final int difference = endTime - startTime;
    if (difference < MINUTE_MILLIS) {
      switch (language) {
        case Language.ENGLISH:
          return "now";
      ...
      switch (language) {
        case Language.ENGLISH:
          return "${(difference / HOUR_MILLIS).toString().split(".")[0]} ${isShort ? 'hr' : 'hours $suffixText'}";
        case Language.ARABIC:
          return "${(difference / HOUR_MILLIS).toString().split(".")[0]} ساعات مضت ";
        case Language.GERMAN:
          return "${(difference / HOUR_MILLIS).toString().split(".")[0]} Vor Stunden";
      ...
      switch (language) {
        case Language.ENGLISH:
          return "${(difference / DAY_MILLIS).toString().split(".")[0]} ${isShort ? 'd' : 'days $suffixText'}";
        case Language.ARABIC:
          return "${(difference / DAY_MILLIS).toString().split(".")[0]} أيام مضت ";
        case Language.GERMAN:
          return "${(difference / DAY_MILLIS).toString().split(".")[0]} Vor Tagen";
      ...
      switch (language) {
        case Language.ENGLISH:
          return (difference / MONTH_MILLIS < 2)
              ? "a month ago"
              : "${(difference / MONTH_MILLIS).toString().split(".")[0]} ${isShort ? 'm' : 'months $suffixText'}";
        case Language.ARABIC:
          return (difference / MONTH_MILLIS < 2)
              ? "قبل شهر"
              : "${(difference / MONTH_MILLIS).toString().split(".")[0]} أشهر مضت ";
      ...
      switch (language) {
        case Language.ENGLISH:
          return (difference / YEAR_MILLIS < 2)
              ? "a year ago"
              : "${(difference / YEAR_MILLIS).toString().split(".")[0]} ${isShort ? 'y' : 'years $suffixText'}";
        case Language.ARABIC:
          return (difference / YEAR_MILLIS < 2)
              ? "قبل عام"
              : "${(difference / YEAR_MILLIS).toString().split(".")[0]} سنين مضت ";
