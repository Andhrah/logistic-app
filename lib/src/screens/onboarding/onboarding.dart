...
import 'package:trakk/src/widgets/elipse_img.dart';
import 'package:trakk/src/widgets/skip_button.dart';
...
class _OnboardingState extends State<Onboarding> {
  ...
  List<Map> screenStates = [
    ...
    },
    {
      ...
      'pageText': [
        'Receive your item',
        'Receive your delivery and get notified that your item has been received',
      ]
    }
  ];
