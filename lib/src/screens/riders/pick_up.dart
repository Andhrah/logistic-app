...
class _PickUpScreenState extends State<PickUpScreen> {
  ...
  static const LatLng _riderLatLng =
      LatLng(6.537827, 3.381352); // current rider location -latlng
  static const LatLng _pickUpLatLng =
      LatLng(6.539173, 3.384168); // pickup location -latlng
