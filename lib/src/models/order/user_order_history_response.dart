class UserOrderHistoryResponse {
  ...
  final String? status;
  final List<UserOrderHistoryDatum>? data;
  final Meta? meta;

  factory UserOrderHistoryResponse.fromJson(Map<String, dynamic> json) =>
      UserOrderHistoryResponse(
        status: json["status"] == null ? null : json["status"],
        data: json["data"] == null
            ? null
            : List<UserOrderHistoryDatum>.from(
                json["data"].map((x) => UserOrderHistoryDatum.fromJson(x))),
...
class UserOrderHistoryDatum {
  UserOrderHistoryDatum({
    this.id,
    this.attributes,
  });
  ...
  factory UserOrderHistoryDatum.fromJson(Map<String, dynamic> json) =>
      UserOrderHistoryDatum(
  ...
  factory OrderHistoryDatumAttributes.fromJson(Map<String, dynamic> json) =>
      OrderHistoryDatumAttributes(
        ...
        pickupLongitude: json["pickupLongitude"] == null
            ? null
            : double.tryParse(json["pickupLongitude"].toString()) ?? 0.0,
        ...
        destinationLatitude: json["destinationLatitude"] == null
            ? null
            : double.tryParse(json["destinationLatitude"].toString()) ?? 0.0,
        destinationLongitude: json["destinationLongitude"] == null
            ? null
            : double.tryParse(json["destinationLongitude"].toString()) ?? 0.0,
